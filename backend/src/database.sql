...
VALUES ('E201', 'P003', 501, '2020-06-12');
...
VALUES ('V001', 'Automatic', 'FWD', 4, 'Petrol', 17.50),
...
VALUES (801, '2025-10-06', 1200000, 'V001', 'C1001'),
...
ALTER TABLE resaleowner
MODIFY COLUMN ownerid INT AUTO_INCREMENT;
-- Re-add the foreign key constraint
ALTER TABLE resalevehicle
ADD CONSTRAINT resalevehicle_ibfk_2 FOREIGN KEY (OwnerId) REFERENCES resaleowner(ownerid);
COMMIT;
